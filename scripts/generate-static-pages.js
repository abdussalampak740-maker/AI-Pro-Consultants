...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Privacy Policy | AI Pro Consultants</title>
  <meta name="description" content="Privacy Policy for AI Pro Consultants. Learn how we collect, use, and protect your personal information." />
  <meta name="keywords" content="privacy policy, AI Pro Consultants, data safety, legal disclosure" />
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="https://www.aiproconsultants.com/privacy-policy" />
...
<body class="selection:bg-blue-500 selection:text-black">

  ${MAIN_NAV}

  <div class="pt-32 pb-24 min-h-screen relative text-slate-300">
    <div class="absolute inset-0 bg-[linear-gradient(to_right,#1118270d_1px,transparent_1px),linear-gradient(to_bottom,#1118270d_1px,transparent_1px)] bg-[size:4rem_4rem] pointer-events-none"></div>
    <div class="absolute top-0 left-1/4 w-[500px] h-[500px] bg-blue-500/5 rounded-full filter blur-[100px] pointer-events-none"></div>

    <div class="max-w-4xl mx-auto px-6 relative z-10">
      <!-- Header section -->
      <div class="text-center space-y-4 mb-16">
        <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[11px] font-bold uppercase tracking-widest">
        ...
        <h1 class="text-4xl md:text-5xl font-black uppercase text-white tracking-tight leading-tight">
          Privacy Policy
        </h1>
        <p class="text-slate-500 text-xs font-mono uppercase tracking-wider">
          Last Updated: July 2026
        </p>
      </div>

      <!-- Policy Content -->
      <div class="p-8 md:p-12 rounded-3xl border border-white/10 bg-[#0c1017]/50 backdrop-blur-sm space-y-8 text-sm md:text-base leading-relaxed font-light">
        <div>
          <p class="text-slate-300">
            AI Pro Consultants (“we,” “us,” or “our”) respects your privacy and is committed to protecting the personal information you provide to us.
          </p>
        </div>

        <div class="space-y-4">
          <h2 class="text-xl font-bold uppercase text-white tracking-tight border-b border-white/5 pb-2">
        ...
        <div class="space-y-4">
          ...
          <div class="p-6 rounded-2xl bg-white/2 border border-white/5 mt-4 space-y-2 text-slate-300">
            <p class="font-bold text-white uppercase tracking-tight text-base">AI Pro Consultants</p>
            <p>Website: <a href="https://www.aiproconsultants.com" class="text-blue-400 hover:underline">www.aiproconsultants.com</a></p>
            <p>Email: <a href="mailto:aiproconsultantss@gmail.com" class="text-blue-400 hover:underline">aiproconsultantss@gmail.com</a></p>
          </div>
        </div>
      </div>
    </div>
...
function run() {
  ...
  // 4. Generate Privacy Policy page
  const privacyPath = path.join(publicDir, 'privacy-policy.html');
  fs.writeFileSync(privacyPath, generatePrivacyPolicyPage(), 'utf8');
